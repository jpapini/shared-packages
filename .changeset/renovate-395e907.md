...
Updated dependency `vite-plugin-dts` to `4.2.4`.
Updated dependency `npm-run-all2` to `6.2.4`.
Updated dependency `vite` to `5.4.9`.
Updated dependency `packageManager` to `pnpm@9.12.2`.
Updated dependency `node` to `20.18.0`.
Updated dependency `pnpm` to `9.12.2`.
Updated dependency `typescript` to `5.6.3`.
Updated dependency `stylelint` to `16.10.0`.
Updated dependency `prettier-plugin-packagejson` to `2.5.3`.
Updated dependency `prettier-plugin-tailwindcss` to `0.6.8`.
Updated dependency `@nestjs/common` to `10.4.5`.
...
Updated dependency `html-webpack-plugin` to `5.6.2`.
Updated dependency `postcss` to `8.4.47`.
Updated dependency `tailwindcss` to `3.4.14`.
